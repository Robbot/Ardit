...
class PdfReport:
    ...
    their due amount and the period of a bill
    """
    ...
    def generate(self, flatmate1, flatmate2, bill):
        ...
        flatmate2_pay = str(round(flatmate1.pays(bill, flatmate1), 2))
        ...
        pdf.cell(w=150, h=40, txt=bill.period, border=9, ln=1)
        ...
        pdf.cell(w=150, h=40, txt=flatmate2_pay, border =0)
